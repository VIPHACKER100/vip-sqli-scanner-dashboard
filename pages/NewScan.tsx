          ...
          <div className="lg:col-span-3">
            <ConfigCard title="Target Intelligence Hub" icon={Globe} colorClass="text-primary-400">
              <div className="relative group/field h-full">
                ...
                <textarea
                  className="w-full h-48 bg-gray-50/50 dark:bg-gray-950/50 border border-gray-200 dark:border-white/5 rounded-3xl p-6 pl-14 text-gray-900 dark:text-gray-200 focus:border-primary-500/30 focus:ring-4 focus:ring-primary-500/5 outline-none font-mono text-xs leading-relaxed transition-all resize-none shadow-inner"
